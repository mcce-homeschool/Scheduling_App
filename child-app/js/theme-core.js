...
(function (g) {
  ...
  // Home-screen wording + signature-visual descriptor (Module 10 §2 parts 3 & 4:
  // Copy pack and Signature reward visual). `visual` names which daily-completion
  // graphic the home hero renders — "bar" is the shared generic; signature themes
  // override with their own. Templated fields use {name}/{part}/{done}/{total}.
  var GENERIC_HOME = {
    eyebrow: "", titleTemplate: "{part}, {name}!", upper: false,
    sub: "Here's your day — take it in any order you like.",
    progressLabel: "done today", streakLabel: "day streak", earnLabel: "earned",
    visual: "bar", visualTitle: "Today's progress",
    visualNoteDone: "{done} of {total} done — keep it going!",
    visualNoteAll: "All done for today! 🎉",
    visualNoteEmpty: "Nothing due today. Enjoy the breather."
  };

  // Shared by every Palette theme — only the Palette itself is custom per
  // Palette theme (Module 10 §2/FR-1).
  var GENERIC_COPY = { brand: "Daily Plan", rewardsTitle: "Rewards", home: GENERIC_HOME };
  ...
  var THEMES = {
    ...
    stable: {
      ...
      copy: {
        brand: "The Stable", rewardsTitle: "Ribbons earned",
        home: {
          eyebrow: "🌅 Saddle up", titleTemplate: "{part}, {name}!", upper: false,
          sub: "Your trail's all set. Let's ride. 🐴",
          progressLabel: "on the trail", streakLabel: "grooming streak", earnLabel: "ribbons",
          visual: "rail", visualTitle: "🎗️ Your ribbon rail",
          visualNoteDone: "A ribbon for every finish — {done} earned today!",
          visualNoteAll: "Every ribbon earned. What a ride today! 🏇",
          visualNoteEmpty: "Finish your first ride to pin a ribbon."
        }
      },
      categoryDisplay: {
    ...
    builder: {
      ...
      copy: {
        brand: "Builder", rewardsTitle: "Resources gathered",
        home: {
          eyebrow: "⛏ Keep building", titleTemplate: "Let's build, {name}!", upper: true,
          sub: "{done} of {total} blocks mined today.",
          progressLabel: "blocks today", streakLabel: "build streak", earnLabel: "resources",
          visual: "grid", visualTitle: "🏰 Your build",
          visualNoteDone: "Every finished block builds your castle. Keep going!",
          visualNoteAll: "Castle complete for today! 🏰",
          visualNoteEmpty: "Mine your first block to start building."
        }
      },
      categoryDisplay: {
